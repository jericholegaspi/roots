...
<title>Appointment List</title>
 ...
 <link rel="stylesheet" type="text/css" href="assets/css/appointmentListPage.css">
...
<nav aria-label="...">
  ...
  <table id="cart" class="table table-hover table-condensed">
    ...
    <tbody>
      <tr>
        <td data-th="Modality">Hilot</td>
        <td data-th="Reservation">
          Name of Place<br>
          <small>Oct. 21, 2019 1:00 PM</small>
        </td>
        <td data-th="Appointment Status">Accepted</td>
        <td data-th="Payment Status">Not Paid</td>
        <td data-th="Date Submitted">10/12/19</td>
        <td class="actions" data-th="">
          <a href="userAppointmentPage.jsp" class="btn btn-primary btn-sm"> View</a>            
        </td>
      </tr>
    </tbody>
  </table>
