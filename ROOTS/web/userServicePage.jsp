...
<title>Services</title>
 ...
 <link rel="stylesheet" type="text/css" href="assets/css/servicePage.css">
...
<!-- START of hero -->
  ...
  <div class="hero-text">
    ...
    <hr>
    <p class="description">Following modalities are handled by the Philippine Institute of Traditional and Alternative Health Care (PITAHC)</p>
  </div>
</div>
</div>
...
<div class="container service">
      ...
      <div class="row" id="myDIV">
        ...
        <div class="col">
          <div class="card item">
          <img class="card-img-top responsive-img" src="assets/css/images/chiro.jpg" alt="Card image" style="width:100%; height:200px;">
          <div class="card-body">
        ...
        <div class="col">
          <div class="card item">
          <img class="card-img-top responsive-img" src="assets/css/images/hilot.jpg" alt="Card image" style="width:100%; height:200px;">
          <div class="card-body">
