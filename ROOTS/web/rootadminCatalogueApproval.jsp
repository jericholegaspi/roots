                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                ...
                                <h4 class="title">List of Pending Catalogue Approvals</h4>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form action="#" method="post" id="archiveProduct">
            ...
            <p class="text-center">Are you sure you want to approve this catalogue?</p>
		</form>
      </div>
...
<script type="text/javascript">
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'pe-7s-bell',
                message: "Welcome to the Catalogue Approvals Page"
