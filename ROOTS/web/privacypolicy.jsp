		...
		<div class="row">
			<div class="card center-block">
				<div class="card-header">
					<h3 class="text-center text-success">Privacy Policy</h3>
<hr>

<div class="row">
	<p><center> ROOTS ("us", "we", or "our") operates the www.roots.ph website (hereinafter
...
<table>
	<td>
		...
		<tr><ul>
			<li><u>Service</u></li>
				<p>Service is the www.roots.ph website operated by ROOTS</p>
			<li><u>Personal Data</u></li>
	...
	<td>
		<tr><b>Information Collection and Use</b></tr>
		<ul><li>We collect several different types of information for various purposes to
provide and improve our Service to you.</li>
	</td>
	<td>
		<tr><b>Types of Data Collected</b></tr>
		<tr><ul>
			<li><u>Personal Data</u></li>
...
<td>
	<tr><b>Use of Data </b></tr>
		<ul><li>ROOTS uses the collected data for various purposes:</li>
		<ul>
...
those from your jurisdiction.</p>
	<p>If you are located outside Philippines and choose to provide information to
us, please note that we transfer the data, including Personal Data, to
Philippines and process it there.</p>
...
information represents your agreement to that transfer.</p>
	<p>ROOTS will take all steps reasonably necessary to ensure that your data is
...
<td>
	<tr><b>Disclosure Of Data </b></tr>
		<ul>
			<li><u>Legal Requirements</u></li>		
				<p>ROOTS may disclose your Personal Data in the good faith belief that such
action is necessary to:</p>
					<ul>
						<li>To comply with a legal obligation</li>
						<li>To protect and defend the rights or property of ROOTS</li>
...
<td>
	<tr><b>Security of Data</b></tr>
	<p>The security of your data is important to us but remember that no method of
transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal
Data, we cannot guarantee its absolute security.
</p>
</td>
<td>
	<tr><b>Service Providers</b></tr>
...
<td>
	<tr><b>Links to Other Sites</b></tr>
...
<td>
	<tr><b>Changes to This Privacy Policy</b></tr>
