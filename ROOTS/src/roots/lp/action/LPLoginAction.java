...
public class LPLoginAction extends ActionSupport implements SessionAware, ServletRequestAware{
	 ...
	 public String execute()
	 {
		 ...
		 try {
			 String userValidate = loginDao.authenticateLP(loginBean);
