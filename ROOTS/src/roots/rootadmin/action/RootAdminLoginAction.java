package roots.rootadmin.action;
...
public class RootAdminLoginAction extends ActionSupport implements SessionAware, ServletRequestAware{
	 ...
	 public String execute()
	 {
		 ...
		 try {
			 String userValidate = loginDao.authenticateRootAdmin(loginBean);
			 userId = loginDao.retrieveUserId(loginBean);
			 if(userValidate.equals("login"))
			 {
				 System.out.println("Root Admin Page");
