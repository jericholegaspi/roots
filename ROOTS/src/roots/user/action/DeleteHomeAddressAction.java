...
public class DeleteHomeAddressAction extends ActionSupport implements ModelDriven<AddressBean> {
	...
	public String execute() {
		...
		addressObj.deleteHome();
		
		//TO DISPLAY DATA IN CONSOLE
		System.out.println("Delivery Address ID: " + addressObj.getDeliveryAddressID());
